...
public class TopDiscussions implements Subscriber {
    private int runs;
    private int wickets;
    private float overs;
    private List<Publisher> publishers;

    public TopDiscussions(List<Publisher> publishers) {
    ...
    public void update(Publisher publisher) {
        ...
        System.out
                .println("TopDiscussion are : " + this.runs + ", " + this.wickets + ", " + this.overs + ".");
    }
